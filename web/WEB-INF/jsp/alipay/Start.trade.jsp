...
<%--        <h2 id="tab5" name="tab">交 易 关 闭</h2>--%>
    ...
    <form name="lipayment" action="AliPayTradePagePay" method="post"
          target="_blank">
...
<%--                    <input id="WIDsubject" name="WIDsubject" />--%>
                        <c:out value="${sessionScope.order.orderId}" />
                </dd>
                <hr class="one_line">
                <dt>付款金额 ：</dt>
                <dd>
...
<%--                    ${sessionScope.order.totalPrice}--%>
                        <c:out value="${sessionScope.order.totalPrice}" />
                </dd>
                <hr class="one_line">
                <dt>商品描述：</dt>
                <dd>
...
<%--          action=../../untitled/demo/src/main/webapp/WEB-INF/alipay.trade.fastpay.refund.query.jsp method=post--%>
<%--          target="_blank">--%>
...
<%--        </div>--%>
<%--    </form>--%>
<%--    <form name=tradeclose action=../../untitled/demo/src/main/webapp/WEB-INF/alipay.trade.close.jsp method=post--%>
<%--          target="_blank">--%>
